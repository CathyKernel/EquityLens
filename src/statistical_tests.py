...
results feed the analysis report and the QQ-plot figure.
"""
...
# Unified figure style (matches the EDA module so every chart in the PDF
# report shares one visual language)
plt.rcParams.update({
    "figure.dpi": 150,
    "savefig.dpi": 150,
    "font.size": 11,
